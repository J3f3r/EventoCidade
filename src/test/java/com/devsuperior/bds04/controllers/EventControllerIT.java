...
public class EventControllerIT {
	...
	@Test
	public void insertShouldReturn404WhenAdminLoggedAndCityIdDoesNotExist() throws Exception {

	    LocalDate nextMonth = LocalDate.now().plusMonths(1L);
	    Long nonExistingCityId = 99999L; // Um ID que com certeza nao existe no banco de dados do teste
	    
	    EventDTO dto = new EventDTO(null, "Show de Rock", nextMonth, "https://rockfest.com", nonExistingCityId);
	    String jsonBody = objectMapper.writeValueAsString(dto);
	    ...
	    // Espera que o status de resposta seja 404 (Not Found)
